                  ...
                  ? BlocProvider<PjpBloc>(
                      ...
                      child: BlocListener<PjpBloc, PjpState>(
                        listener: (context, state) {
                          ...
                          if (state is UpdatePjpFailureState) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                width: MediaQuery.of(context).size.width,
                                padding:
                                    const EdgeInsets.fromLTRB(14, 15, 14, 10),
                                child: const Text(
                                  "Working plan",
                                  textAlign: TextAlign.left,
                                  style: TextStyle(
