...
class GetRetailersTaskResponse {
  ...
  factory GetRetailersTaskResponse.fromJson(String str) => GetRetailersTaskResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetRetailersTaskResponse.fromMap(Map<String, dynamic> json) => GetRetailersTaskResponse(
        success: json["success"] ?? false,
        message: json["message"] ?? "",
        data: json["data"] == null ? [] : List<RetailersTaskModal>.from(json["data"].map((x) => RetailersTaskModal.fromMap(x))),
      );
...
class RetailersTaskModal {
  ...
  factory RetailersTaskModal.fromJson(String str) => RetailersTaskModal.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory RetailersTaskModal.fromMap(Map<String, dynamic> json) => RetailersTaskModal(
        retailerId: json["retailer_id"] == null ? "" : json["retailer_id"].toString(),
        ...
        enrollmentDate: json["enrollment_date"] == null ? "" : json["enrollment_date"].toString(),
        ...
        enrollmentTypeName: json["enrollment_type_name"] == null ? "" : json["enrollment_type_name"].toString(),
        ...
        lastOrder: json["last_order"] == null ? "" : json["last_order"].toString(),
        ...
        orderBookingDay1: json["order_booking_day1"] == null ? "" : json["order_booking_day1"].toString(),
        orderBookingDay2: json["order_booking_day2"] == null ? "" : json["order_booking_day2"].toString(),
        ...
        taskHistory: json["task_history"] == null ? "" : json["task_history"].toString(),
        taskWiseData: json["task_wise_data"] == null
            ? []
            : List<TaskWiseRetailersTaskModal>.from(json["task_wise_data"].map((x) => TaskWiseRetailersTaskModal.fromMap(x))),
        lastEscalation: json["last_escalation"] == null
            ? []
            : List<LastEscalation>.from(json["last_escalation"].map((x) => LastEscalation.fromMap(x))),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "task_wise_data": List<dynamic>.from(taskWiseData.map((x) => x.toMap())),
        "last_escalation": List<dynamic>.from(lastEscalation.map((x) => x.toMap())),
      };
}
...
class LastEscalation {
  ...
  factory LastEscalation.fromJson(String str) => LastEscalation.fromMap(json.decode(str));
  ...
  factory LastEscalation.fromMap(Map<String, dynamic> json) => LastEscalation(
        ...
        reassignDate: json["reassign_date"] == null ? "" : json["reassign_date"].toString(),
        ...
        reassignRemark: json["reassign_remark"] == null ? "" : json["reassign_remark"].toString(),
...
class TaskWiseRetailersTaskModal {
  ...
  factory TaskWiseRetailersTaskModal.fromJson(String str) => TaskWiseRetailersTaskModal.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory TaskWiseRetailersTaskModal.fromMap(Map<String, dynamic> json) => TaskWiseRetailersTaskModal(
        taskNumber: json["task_number"] == null ? "" : json["task_number"].toString(),
        escalationTag: json["escalation_tag"] == null ? "" : json["escalation_tag"].toString(),
        taskType: json["task_type"] == null ? "" : json["task_type"].toString(),
      );
