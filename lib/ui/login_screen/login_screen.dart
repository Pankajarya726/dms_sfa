      ...
      child: BlocListener<LoginBloc, LoginState>(
        ...
        listener: (context, state) async {
          if (state is LoginSuccessState) {
            ...
            SharedPreference.setStringPreference(
                SharedPreference.userId, state.data.id.toString());

            SharedPreference.setBooleanPreference(
                SharedPreference.isLogin, true);

            SharedPreference.setBooleanPreference(
                SharedPreference.isLeader, state.data.isLeader);

            SharedPreference.setStringPreference(
                SharedPreference.accessToken, state.data.accessToken);

            SharedPreference.setStringPreference(SharedPreference.fromDate,
                DateFormat("yyyy-MM-dd").format(state.data.pjpButton.fromDate));
            SharedPreference.setStringPreference(SharedPreference.toDate,
                DateFormat("yyyy-MM-dd").format(state.data.pjpButton.toDate));
            ...
            SharedPreference.setStringPreference(
                SharedPreference.startMyDay, state.data.startMyDay);
