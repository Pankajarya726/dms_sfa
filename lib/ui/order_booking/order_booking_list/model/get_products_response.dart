...
class GetProductsResponse {
  ...
  factory GetProductsResponse.fromJson(String str) =>
      GetProductsResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetProductsResponse.fromMap(Map<String, dynamic> json) =>
      GetProductsResponse(
        success: json["success"] ?? false,
        message: json["message"] ?? "",
        data: json["data"] == null
            ? []
            : List<ProductsModal>.from(
                json["data"].map((x) => ProductsModal.fromMap(x))),
      );
...
class ProductsModal {
  ...
  factory ProductsModal.fromJson(String str) =>
      ProductsModal.fromMap(json.decode(str));
