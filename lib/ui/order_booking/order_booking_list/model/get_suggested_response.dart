...
class GetSuggestedResponse {
  ...
  factory GetSuggestedResponse.fromJson(String str) =>
      GetSuggestedResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetSuggestedResponse.fromMap(Map<String, dynamic> json) =>
      GetSuggestedResponse(
        success: json["success"] ?? false,
        message: json["message"] ?? "",
        data: json["data"] == null
            ? []
            : List<SuggestedModal>.from(
                json["data"].map((x) => SuggestedModal.fromMap(x))),
      );
...
class SuggestedModal {
  ...
  factory SuggestedModal.fromJson(String str) =>
      SuggestedModal.fromMap(json.decode(str));
