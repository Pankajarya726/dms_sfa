...
class GetSchemesResponse {
  ...
  bool success;
  String message;
  List<SchemesModal>? data;

  factory GetSchemesResponse.fromJson(String str) =>
      GetSchemesResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetSchemesResponse.fromMap(Map<String, dynamic> json) =>
      GetSchemesResponse(
        success: json["success"] ?? false,
        message: json["message"] ?? "",
        data: json["data"] == null
            ? null
            : List<SchemesModal>.from(
                json["data"].map((x) => SchemesModal.fromMap(x))),
      );
...
class SchemesModal {
  ...
  factory SchemesModal.fromJson(String str) =>
      SchemesModal.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory SchemesModal.fromMap(Map<String, dynamic> json) => SchemesModal(
        ...
        pcsPerMoq:
            json["pcs_per_moq"] == null ? "" : json["pcs_per_moq"].toString(),
        pcsPerPackaging: json["pcs_per_packaging"] == null
            ? ""
            : json["pcs_per_packaging"].toString(),
