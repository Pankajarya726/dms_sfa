...
class RetailerDetailsModal {
  ...
  factory RetailerDetailsModal.fromMap(Map<String, dynamic> json) =>
      RetailerDetailsModal(
        ...
        orderBookingDay: json["order_booking_day"] == null
            ? DateFormat.EEEE().format(DateTime.now())
            : json["order_booking_day"].toString(),
        ...
        tcStatus: json["tc_status"] == null
            ? "Not Connected"
            : json["tc_status"].toString(),
        pendingTask: json["pending_task"] == null
            ? "0"
            : json["pending_task"].toString(),
...
class Product {
  ...
  factory Product.fromMap(Map<String, dynamic> json) => Product(
        ...
        variantDescription: json["variant_description"] == null
            ? ""
            : json["variant_description"].toString(),
        mrp: json["mrp"] == null ? "0" : json["mrp"].toString(),
        ptrPkgPrice: json["ptr_pkg_price"] == null
            ? "0"
            : json["ptr_pkg_price"].toString(),
        ptrMoqPrice: json["ptr_moq_price"] == null
            ? "0"
            : json["ptr_moq_price"].toString(),
        schemePkgPrice: json["scheme_pkg_price"] == null
            ? "0"
            : json["scheme_pkg_price"].toString(),
        schemeMoqPrice: json["scheme_moq_price"] == null
            ? "0"
            : json["scheme_moq_price"].toString(),
