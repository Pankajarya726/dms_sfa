                                    ...
                                    BlocBuilder<SettingsBloc, SettingsState>(builder: (context, state) {
                                      if (state is DetailsSucessState) {
                                        return state.response.data!.name.isNotEmpty
                                            ...
                                            : const Text(
                                                "Username",
                                                style: TextStyle(color: Color(0xfff24b55), fontSize: 20, fontWeight: FontWeight.w600),
                                              );
                                      }
                                      ...
                                      if (state is DetailsSucessState) {
                                        return state.response.data!.designation.isNotEmpty
                                            ...
                                            : const Text("Designation",
                                                style: TextStyle(color: Color(0xff303030), fontSize: 14, fontWeight: FontWeight.w600));
                                      }
                                    ...
                                    child: BlocBuilder<SettingsBloc, SettingsState>(builder: (context, state) {
                                      if (state is DetailsSucessState) {
                                        return state.response.data!.image.isNotEmpty
                                            ...
                                            : Image.asset("assets/3x/placeholder.png", width: 90, height: 90, fit: BoxFit.cover);
                                      }
                                      return Image.asset("assets/3x/placeholder.png", width: 90, height: 90, fit: BoxFit.cover);
                                    }),
                                  ),
                                ),
                              ),
