...
class _MyProfileDetailsState extends State<MyProfileDetails> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<MyProfileDetailsBloc, MyProfileDetailsState>(
        listener: (context, state) {
          if (state is MyProfileDetailsSelectDateState) {
            dateTime = state.dateTime;
            myProfileDetailsBloc
                .add(MyProfileDetailsInitialEvent(currentDate: "2021-10-26"));
          }
        ...
        builder: (context, state) {
          if (state is MyProfileDetailsInitialState) {
            myProfileDetailsBloc
                .add(MyProfileDetailsInitialEvent(currentDate: "2021-10-25"));
            return const Center(
