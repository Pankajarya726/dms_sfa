                            ...
                            children: [
                              SizedBox(
                                ...
                                child: Image.asset(
                                  ...
                                  color:
                                      isPressed1 ? Colors.white : colorGrayDark,
                                ),
                              ),
                              Text(
                                "Custom",
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: const Border(
                              left: BorderSide(color: colorGray, width: 1.0),
                              right: BorderSide(color: colorGray, width: 1.0),
                            ),
                          ),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                      ...
                      return Container(
                        ...
                        child: GFAccordion(
                          ...
                          contentChild: Column(
                            children: [
                              const Divider(
                                  height: 1, color: Color(0xff898989)),
                              Padding(
