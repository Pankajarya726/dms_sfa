...
class _StartDayScreenState extends State<StartDayScreen> {
  ...
  Map<String, List<String>> secondaryTags = {
    "Retailing": ["Vijay nagar", "Palasiya", "Regel square", "Bangali square", "malwa meel square", "Pardesipura"],
  ...
  TextEditingController txtRemarkController = TextEditingController(text: "today working");
                    ...
                    BlocBuilder<AddPlanBloc, AddPlanStates>(
                      builder: (context, state) {
                        ...
                        if (state is GetSavedPlanState) {
                          // txtRemarkController = TextEditingController(text: state.getAddPlanDataResponse.data!.first.remark);
                        }
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            selectedPrimaryTag == "Retailing" || selectedPrimaryTag == "Joint Working"
                                ? const Padding(
                            ...
                            selectedPrimaryTag == primaryTags[0]
                                ? TextFormField(
                                    ...
                                    onTap: () {
                                      selectBeat(context, secondaryTags[selectedPrimaryTag]!);
                                    },
