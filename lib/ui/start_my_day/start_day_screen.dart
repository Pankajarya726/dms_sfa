        ...
        child: MultiBlocProvider(
          ...
          child: MultiBlocListener(
            listeners: [
              ...
              BlocListener<AddPlanBloc, AddPlanStates>(
                  listener: (context, state) {
                if (state is GetSavedPlanState) {
                  ...
                  List<SecondaryTag> secTag = primaryTagList
                      .singleWhere((element) =>
                          element.id ==
                          int.parse(state.planDateModel.primaryTagId))
                      .secondaryTag;
                      ...
                      children: [
                                ...
                                return Tags(
                                  ...
                                  itemBuilder: (index) {
                                    return ItemTags(
                                      ...
                                      index: index,
                                      border: Border.all(
                                          color: selectedPrimaryTag!.id ==
                                                  primaryTagList[index].id
                                              ? MColor.colorPrimary
                                              : const Color.fromRGBO(
                                                  197, 197, 197, 1)),
                                      activeColor: selectedPrimaryTag!.id ==
                                              primaryTagList[index].id
                            ...
                            BlocBuilder<AddPlanBloc, AddPlanStates>(
                              builder: (context, state) {
                                ...
                                if (state is SelectSecondaryState) {
                                  ...
                                  debugPrint(
                                      "selectedSecondaryTag--->$selectedSecondaryTags");
                                  String selectedBeats = "";
                                  if (selectedSecondaryTags.isNotEmpty) {
                                    for (int i = 0;
                                        i < selectedSecondaryTags.length;
                        ...
                        BlocBuilder<AddPlanBloc, AddPlanStates>(
                          builder: (context, snap) {
                            ...
                            if (selectedPrimaryTag!.id == 5 ||
                                selectedPrimaryTag!.id == 6) {
                              return Container();
                            }
                            return Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
