...
// initially we have to view clockOutLayout
        ...
        onPressed: () async {
          ...
          if (workingPlanController.text.isNotEmpty) {
            if (image != null) {
              ...
              Fluttertoast.showToast(msg: "Please capture clock in selfie");
            }
          } else {
  ...
  startAttendenceTimer(DateTime dateTime) async {
    DateTime startTimerDateTime = await NTP.now();

    String time1 = startTimerDateTime.hour.toString() +
        ":" +
        startTimerDateTime.minute.toString() +
        ":" +
