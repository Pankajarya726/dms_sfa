...
const primaryMobile = "Owner Primary Mobile Number *";
const secondaryMobile = "Owner Secondary Mobile Number";
const helperMobile = "Helper Mobile Number";
const existingRetailer = "Existing Retailer *";
const callTimeSlotMand = "Call Time Slot *";
const callTimeSlot = "Call Time Slot";
const languageFirst = "Language 1 *";
const languageSecond = "Language 2";
const retailerTypeMand = "Retailer Type *";
const retailerType = "Retailer Type";
const retailerCategoryMand = "Retailer Category *";
...
const anniversary = "Wedding Anniversary";
...
const filter = "Filter";
const productInformation = "Product Info";
const schemeInfo = "Scheme Info";
const summary = "Summary";
const syncText = "Sync";
const somethingWR = "Something went wrong!";
const internetCheck = "Please check your internet connection!";
const otpNumber = "Select Number for OTP";
const primary = "Primary";
const secondary = "Secondary";
const helper = "Helper";
const submitAnyway = "Submit Anyway";
